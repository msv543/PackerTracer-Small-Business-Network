...
- DHCP requests fail.
- Pings to reouter subinterfaces fail.
...
7. Reconfigured the uplink as an 802.1Q trunk.
8. Verified restoration of network connectivity.
...
The switch uplink was reconfigured as a trunk and configured to allow all required VLANs.
```
...
- DHCP address assignmed functioned correctly.
